...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="field[@type='tag-list']" mode="field-main">
        <input name="fields[]" type="text" value="$value"/>
    </xsl:template>

    <xsl:template match="field[@class='Symnext\SectionFields\FieldTagList'" mode="field-extra">
	...
	<xsl:template match="field[@type='input']" mode="publish">
