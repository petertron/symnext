...
class DevKit extends HTMLPage
{
     ...
     */
    protected function buildIncludes(): void
    {
     ...
     */
    protected function buildHeader(XMLElement $wrapper): void
    {
        $this->setTitle(__(
     ...
     * @throws InvalidArgumentException
     */
    protected function buildNavigation(XMLElement $wrapper): void
    {
        $xml = new DOMDocument();
     ...
     * @return XMLElement
     */
    protected function buildJumpItem(
        string $name,
        string $link,
        bool $active = false
    ): XMLElement
