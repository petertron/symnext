...
use Symnext\Interface\IFileResource;
...
class EventManager implements IFileResource
{
    /**
     ...
     * @return string
     */
    public static function __getClassName(string $handle): string
    {
        return 'event' . $handle;
    }
     ...
     */
    public static function __getClassPath(string $handle): string|bool
    {
     ...
     * @return string
     */
    public static function __getDriverPath(string $handle): string
    {
     ...
     * @return Event
     */
    public static function create(string $handle, array $env = null): Event
    {
