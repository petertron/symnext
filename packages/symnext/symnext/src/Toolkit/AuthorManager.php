...
class AuthorManager
{
     ...
     */
    public function fetchByPasswordResetToken(string $token): Author
    {
        if (!$token) {
            return null;
        }
     ...
     *  If the token is not a string
     */
    public function fetchByAuthToken(string $token): Author
    {
        if (!$token) {
            return null;
        }
     ...
     */
    public static function fetchByID(int|array $id): Author|array
    {
        $return_single = false;
