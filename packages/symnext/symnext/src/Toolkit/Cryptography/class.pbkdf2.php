...
class PBKDF2 extends Cryptography
{
     ...
     * the hash
     */
    public static function extractHash(string $input)
    {
     ...
     *  the salt
     */
    public static function extractSalt(string $input): string
    {
        $data = explode('|', $input, 5);
     ...
     * the saltlength
     */
    public static function extractSaltlength(string $input): int
    {
     ...
     */
    public static function extractIterations(string $input): int
    {
        $data = explode('|', $input, 5);

        return intval(empty($data[4]) ? $data[1] : $data[2]);
    }
     ...
     *  the algorithm
     */
    public static function extractAlgorithm(string $input): string
    {
        $data = explode('|', $input, 5);
     ...
     */
    public static function requiresMigration(string $hash): bool
    {
