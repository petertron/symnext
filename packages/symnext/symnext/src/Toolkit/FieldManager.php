...
class FieldManager implements FileResource
{
     ...
     * @return string
     */
    public static function __getHandleFromFilename(string $filename): string
    {
        return preg_replace(['/^field./i', '/.php$/i'], '', $filename);
    }
     ...
     * @return string
     */
    public static function __getClassName(string $type): string
    {
        return 'field' . $type;
    }
     ...
     */
    public static function __getClassPath(string $type): bool|string
    {
     ...
     * @return string
     */
    public static function __getDriverPath(string $type): string
    {
     ...
     * @return boolean
     */
    public static function about(string $name): bool
    {
        return false;
    }
     ...
     */
    public static function saveSettings(int $field_id, array $settings): bool
    {
     ...
     * @return boolean
     */
    public static function edit(int $id, array $fields): bool
    {
     ...
     */
    public static function getInitializedField(int $field_id): ?Field
    {
     ...
     * @return void
     */
    public static function setInitializedField(Field $field): void
    {
    ...
    public static function fetch(
        ...
        string $where = null,
        int|string $restrict = Field::__FIELD_ALL__
    ): array
    {
        if (Symphony::Log()) {
     ...
     * @return string
     */
    public static function fetchFieldTypeFromID(int $id): string
    {
        return Symphony::Database()
            ->select(['type'])
            ->from('tbl_fields')
     ...
     * @return string
     */
    public static function fetchHandleFromID(int $id): string
    {
        return Symphony::Database()
            ->select(['element_name'])
            ->from('tbl_fields')
     ...
     * @return mixed
     */
    public static function fetchFieldIDFromElementName(
     ...
     */
    public static function fetchNextSortOrder(): int
    {
     ...
     * `type` and `location`
     */
    public static function fetchFieldsSchema(int $section_id): array
    {
        return Symphony::Database()
    ...
    public static function create(string $type): Field
    {
        if (!isset(self::$_pool[$type])) {
            ...
            if (!file_exists($path)) {
                throw new Exception(
                    __('Could not find Field %1$s at %2$s.', ['<code>' . $type . '</code>', '<code>' . $path . '</code>'])
     ...
     * @return boolean
     */
    public static function isFieldUsed(string $field_type): bool
    {
        return Symphony::Database()
            ->select()
            ->count()
     ...
     */
    public static function isTextFormatterUsed(string $text_formatter_handle): bool
    {
     ...
     * @return FieldQuery
     */
    public function select(array $projection = []): FieldQuery
    {
