...
class Section implements ArrayAccess
{
    ...
    public function getSortingField()
    {
         ...
         */
        Symphony::ExtensionManager()->notifyMembers('SectionGetSortingField', '/publish/', [
    ...
    public function getSortingOrder()
    {
         ...
         */
        Symphony::ExtensionManager()->notifyMembers('SectionGetSortingOrder', '/publish/', [
            'section-handle' => $this->get('handle'),
            'order' => &$result
        ]);
    ...
    public function setSortingField($sort, $write = true)
    {
         ...
         */
        Symphony::ExtensionManager()->notifyMembers('SectionSetSortingField', '/publish/', [
            'section-handle' => $this->get('handle'),
            'field' => $sort,
            'updated' => &$updated,
        ]);
    ...
    public function setSortingOrder($order, $write = true)
    {
         ...
         *  The updated flag, set by extensions, which prevents the saving of the value
         */
        Symphony::ExtensionManager()->notifyMembers('SectionSetSortingOrder', '/publish/', [
            'section-handle' => $this->get('handle'),
            'order' => $order,
            'updated' => &$updated,
        ]);
