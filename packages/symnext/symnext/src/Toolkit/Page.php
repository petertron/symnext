...
abstract class Page
{
     ...
     */
    final public static function getHttpStatusValue(
     ...
     */
    final public static function getHeaderStatusString(int $status_code): string
    {
        return sprintf("Status: %d %s", $status_code, self::getHttpStatusValue($status_code));
    }

    /**
     * Sets the `$string_value` for the specified `$status_code`.
     ...
     */
    final public static function setHttpStatusValue(
        int $status_code,
    ...
    ): void
    {
        ...
        } elseif ($status_code >= 100 && $status_code < 600) {
     ...
     */
    public function addHeaderToPage(
        string $name,
        string $value = null,
     ...
     */
    public function removeHeaderFromPage(string $name): void
    {
    ...
    {
        return $this->_headers['status']['response_code'] ?? self::HTTP_STATUS_OK;
    }
     ...
     * @param integer $status_code
     */
    final public static function renderStatusCode(int $status_code): void
    {
