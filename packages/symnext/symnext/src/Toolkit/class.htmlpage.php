...
class HTMLPage extends Page
{
    ...
    public function setTitle($title)
    {
        return $this->addElementToHead(
            new XMLElement('title', $title), null, false
        );
    }
     ...
     */
    protected function __generateHead(): void
    {
        ksort($this->_head);
     ...
     */
    public function removeFromHead(string $elementName): void
    {
     ...
     * @param integer $position
     */
    public function removeFromHeadByPosition(int $position): void
    {
     ...
     * @return boolean
     */
    public function checkElementsInHead(string $path, string $attribute): bool
    {
    ...
    public function addStylesheetToHead(
        string $path, string $type = 'screen',
        int $position = null,
        bool $duplicate = true
    ): int
    {
