...
final class DatabaseAlter extends DatabaseStatement
{
     ...
     * @return bool
     */
    public function containsAddDropOrChange(): bool
    {
     ...
     *  The current instance
     */
    public function drop(array|string $columns): self
    {
        if (!is_array($columns)) {
            $columns = [$columns];
        }
     ...
     *  The current instance
     */
    public function modify(array $columns): self
    {
        $columns = implode(self::LIST_DELIMITER, General::array_map(function ($k, $column) {
            $column = $this->buildColumnDefinitionFromArray($k, $column);
     ...
     *  The current instance
     */
    public function addKey(array|string $keys): self
    {
        if (!is_array($keys)) {
            $keys = [$keys => 'key'];
        }
     ...
     *  The current instance
     */
    public function dropKey(array|string $keys): self
    {
        if (!is_array($keys)) {
            $keys = [$keys];
        }
     ...
     *  The current instance
     */
    public function addIndex(array|string $keys): self
    {
        if (!is_array($keys)) {
            $keys = [$keys => 'index'];
        }
     ...
     *  The current instance
     */
    public function dropIndex(array|string $keys): self
    {
        if (!is_array($keys)) {
            $keys = [$keys];
        }
     ...
     *  The current instance
     */
    public function addPrimaryKey(array|string $keys): self
    {
        if (!is_array($keys)) {
            $keys = [$keys => 'primary'];
        }
