 ...
 * This class is also responsible for creating the Field object based on what
...
class FieldQueryResult extends DatabaseQueryResult
{
     ...
     * @return Field
     */
    protected function process(object|array $next): object|array #Field
    {
     ...
     */
    public function restrict(int $restriction): self
    {
     ...
     */
    public function buildField(array $row): Field
    {
