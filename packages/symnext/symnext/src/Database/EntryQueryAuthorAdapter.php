 ...
 * filtering/sorting data from an author Field.
 * @see FieldAuthor
...
class EntryQueryAuthorAdapter extends EntryQueryFieldAdapter
{
     ...
     */
    public function isFilterAuthorId(string $string): bool
    {
     ...
     *  The filter array
     */
    public function createFilterAuthorId(string $filter, array $columns): array
    {
     ...
     */
    public function sort(EntryQuery $query, ?string $direction = 'ASC'): void
    {
        $field_id = General::intval($this->field->get('id'));
