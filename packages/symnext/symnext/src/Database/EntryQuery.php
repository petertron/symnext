...
class EntryQuery extends DatabaseQuery
{
    ...
    )
    {
        ...
        $this->sectionId = $section_handle;
        $this->from("tbl_section:$section_handle")->alias('e')->schema($schema);
    }
     ...
     *  The current instance
     */
    public function disableDefaultProjection(): self
    {
     ...
     * @return array
     */
    public function getMinimalProjection(): array
    {
     ...
     */
    public function count(string $col = null): DatabaseQuery
    {
     ...
     */
    public function isFieldJoined(string $field_id): bool
    {
     ...
     * @return void
     */
    protected function fieldJoined(string $field_id, string $join): void
    {
    ...
    public function includeAllFields(): self
    {
        if (!$this->sectionId) {
            throw new DatabaseStatementException(
                'Cannot include all fields before calling section()'
            );
        }
     ...
     *  The current instance
     */
    public function entry(int $entry_id): self
    {
     ...
     *  The current instance
     */
    public function entries(array $entry_ids): self
    {
     ...
     *  The current instance
     */
    public function innerJoinField(string $field_id): self
    {
     ...
     *  The current instance
     */
    public function joinField(string $field_id): self
    {
        if ($this->isFieldJoined($field_id)) {
            return $this;
        }
        ...
        return $this
            ->join("tbl_section:{$this->sectionId}:$field_id", "f{$field_id}")
            ->on(['e.id' => "\$f{$field_id}.entry_id"]);
    }
     ...
     *  The current instance
     */
    public function leftJoinField(string $field_id): self
    {
        if ($this->isFieldJoined($field_id)) {
            return $this;
        }
        ...
        return $this
            ...
            ->leftJoin("tbl_section_$field_id", "f{$field_id}")
            ->on(['e.id' => "\$f{$field_id}.entry_id"]);
    }
     ...
     *  The current instance
     */
    public function outerJoinField(string $field_id): self
    {
        if ($this->isFieldJoined($field_id)) {
            return $this;
        }
     ...
     *  The current instance
     */
    public function rightJoinField(string $field_id): self
    {
        if ($this->isFieldJoined($field_id)) {
            return $this;
        }
     ...
     *  The current instance
     */
    public function whereField(string $field_id, array $conditions): self
    {
        if (!$this->isFieldJoined($field_id)) {
    ...
    public function sort(string $field, string $direction = 'ASC'): self
    {
        ...
        if (strtoupper($direction) === 'RAND' or strtoupper($direction) === 'RANDOM') {
            $sort = ['e.id' => 'RAND()'];
     ...
     * @return string
     */
    public function buildLegacySortingForField(
        Field $f,
        string $direction
    ): string
    {
     ...
     * @return DatabaseQuery
     */
    public function countProjection(
        string $col = 'DISTINCT(e.id)'
    ): DatabaseQuery
    {
     ...
     *  The wrapped result
     */
    public function results(bool $success, PDOStatement $stm): EntryQueryResult
    {
        return new EntryQueryResult(
            $success, $stm, $this, $this->page, $this->schema
        );
    }
}
