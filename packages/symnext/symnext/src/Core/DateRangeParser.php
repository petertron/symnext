...
class DateRangeParser
{
     ...
     */
    public function includeLimits(): self
    {
    ...
    {
        if (!in_array($direction, ['earlier', 'later'])) {
            throw new Exception('Invalid date range parser direction.');
        }
     ...
     */
    public function expandRange(array $parts): array
    {
        if (!$this->includeLimits) {
            return $parts;
        }
