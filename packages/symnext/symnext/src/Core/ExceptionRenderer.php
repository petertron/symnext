...
class ExceptionRenderer
{
     ...
     * @return array
     */
    protected static function getNearbyLines(
        int $line,
        string $file,
        int $window = 5
    )
     ...
     * @return void
     */
    public static function sendHeaders(\Throwable $e)
    {
        if (!headers_sent()) {
    ...
    protected static function renderHtml(\Throwable $e)
    {
        ...
        $html = str_replace('{ASSETS_URL}', '/', $html);
     ...
     */
    protected static function renderText(\Throwable $e)
    {
        $message = $e->getMessage() . ($e->getPrevious()
