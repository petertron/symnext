...
class SymnextException extends \Exception
{
    /**
    ...
    /**
     * Constructor for SymphonyException sets its class variables
     *
     ...
     * @return XMLElement
     */
    public function getMessageObject(): Toolkit\XMLElement|null
    {
     ...
     * @return string
     */
    public function getTemplateName(): string|null
    {
