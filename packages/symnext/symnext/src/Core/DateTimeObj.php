...
class DateTimeObj
{
     ...
     */
    protected static $date_mappings = [
     ...
     */
    protected static $time_mappings = [
     ...
     */
    public static function getSetting(string $name = null): array|string|null
    {
        if (is_null($name)) {
    ...
    public static function setDefaultTimezone(string $timezone): void
    {
        if (!@date_default_timezone_set($timezone)) {
            throw new Exception(__('Invalid timezone %s', [$timezone]));
        }
    }
     ...
     */
    public static function parse(string $string): DateTime|bool
    {
     ...
     * @return array
     */
    public static function getTimezones(string $zone = null): array
    {
     ...
     */
    public static function getTimezonesSelectOptions(string $selected = null): array
    {
        $zones = self::getZones();
        $groups = [];
        ...
        foreach ($zones as $zone => $value) {
            ...
            foreach ($timezones as $timezone) {
                ...
                $options[] = [$timezone, ($timezone == $selected), sprintf(
                    "%s %s",
            ...
            $groups[] = ['label' => ucwords(strtolower($zone)), 'options' => $options];
        }
     ...
     * @return array
     */
    public static function getDateFormatMappings(): array
    {
     ...
     * @return array
     */
    public static function getMomentDateFormats(): array
    {
     ...
     * @return string
     */
    public static function convertDateToMoment(string $format): string
    {
     ...
     * @return string
     */
    public static function convertMomentToDate(string $format): string
    {
     ...
     *  An associative array, for use with `Widget::Select`
     */
    public static function getDateFormatsSelectOptions(string $selected = null): array
    {
        ...
        foreach ($formats as $option) {
            ...
            $options[] = [$option, $option == $selected, self::format('now', $option) . $leadingZero];
        }
     ...
     * @return array
     */
    public static function getMomentTimeFormats(): array
    {
        return array_keys(self::$time_mappings);
    }
     ...
     * @return string
     */
    public static function convertTimeToMoment(string $format): string
    {
     ...
     * @return string
     */
    public static function convertMomentToTime(string $format): string
    {
     ...
     *  An associative array, for use with `Widget::Select`
     */
    public static function getTimeFormatsSelectOptions(string $selected = null)
    {
        $formats = self::getTimeFormats();
        $options = [];

        foreach ($formats as $option) {
            $options[] = [$option, $option == $selected, self::get($option)];
        }
