...
class Log
{
    ...
    public function writeToLog($message, $addbreak = true)
    {
        ...
        $permissions = App::Configuration() ? App::Configuration()->get('write_mode', 'file') : '0664';
     ...
     *  void
     */
    public function pushDeprecateWarningToLog(
        string $method,
        $alternative = null,
        array $opts = []
    ): bool|null
    {
        ...
        return $this->pushToLog(
            $message, E_DEPRECATED, $opts['write-to-log'], $opts['addbreak'], $opts['append']
        );
    }
     ...
     */
    public function open(int $flag = self::APPEND, $mode = 0777)
    {
    ...
    {
        $version = (is_null(App::Configuration())) ? VERSION : App::Configuration()->get('version', 'symnext');
