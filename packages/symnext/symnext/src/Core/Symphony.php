 ...
 */
namespace Symnext\Symnext\Lib\Core;
...
abstract class Symphony
{
     ...
     * @return Symphony
     */
    public static function Engine(): Administration|Frontend
    {
     ...
     */
    public static function getEngineNamespace(): string
    {
        return (APP_MODE == 'administration')
            ? '/backend/' : '/' . APP_MODE . '/';
    }
     ...
     */
    public static function initialiseConfiguration(array $data = []): void
    {
        if (empty($data)) {
    ...
    public static function initialiseExtensionManager(bool $force = false)
    {
        ...
        if (!(self::$ExtensionManager instanceof ExtensionManager)) {
            static::throwCustomError(
                __('Error creating Symphony extension manager.')
            );
        }
    }
     ...
     */
    public static function setDatabase(StdClass $database = null): bool
    {
        return true;
    }
    ...
    public static function initialiseDatabase(): ?bool
    {
        ...
        try {
            ...
            static::Database()
                ->setTimeZone(self::Configuration()->get('timezone', 'region'));
    ...
    public static function throwCustomError(
        ...
        string $heading = 'Symphony Fatal Error',
